...
func _ready() -> void:
	...
	# /求文本框大小
	# 求气泡大小并构成气泡
	var __bubble_empty_width_multiplier: float = CBSConfig.bubble_max_width_multiplier - CBSConfig.bubble_text_max_width_multiplier #求气泡与文本的宽度乘数差值，表示气泡边界与文本框边界的距离占视口宽度的比率
